...
module.exports = "\n  <nav class=\"navbar navbar-default\" style=\"display: inline-flex; vertical-align: middle;\">\n    <div class=\"navbar-header\">\n      <a href=\"#/\"><img src=\"assets/logo.jpeg\" class=\"logo\" /></a>\n    </div>\n    <ul class=\"nav navbar-nav nav-pills\">      \n      <li routerLinkActive=\"active\">\n        <a routerLink=\"/reactivedynamicform\">Censo, Tabernáculo de Bogotá</a>\n      </li>     \n    </ul>\n  </nav>\n  \n  <main style=\"display: block;\">\n    <router-outlet></router-outlet>   \n  </main>\n  \n  \n"
...
module.exports = "<div *ngIf=\"!submitted\">\n    <form style=\"width: 80%; margin-left: 10%;\" [formGroup]=\"heroForm\" (ngSubmit)=\"submit()\">\n        <div *ngFor=\"let prop of formModelProps\">            \n            <div class=\"form-group\" *ngIf=\"prop !== 'id'\">\n                <label for=\"name\">{{ prop | cameltotitle }}</label>\n                <input *ngIf=\"prop != 'grupoSanguineo'\" type=\"text\" class=\"form-control\" [formControlName]=\"prop\" />\n                <label for=\"\">{{prop}}</label>\n                <div class=\"alert alert-danger\" [hidden]=\"heroForm.get(prop).valid\">{{ prop }} es requerido</div>                \n            </div>            \n        </div>\n    </form>\n    <form #formRef=\"ngForm\" class=\"form2\">\n        <label for=\"name\">Núcleo Familiar</label>\n        <div *ngFor=\"let word2 of words2; let in=index\">            \n            <div class=\"form-group\" style=\"display:inline-flex; width: 100%;\">                \n              <input type=\"text\" style=\"width: 96%;\" [(ngModel)]=\"words2[in].value1\" placeholder=\"nombre\" name=\"name{{in}}\" class=\"form-control formInput\" #name=\"ngModel\" required />\n              <input type=\"text\" style=\"width: 96%;\" [(ngModel)]=\"words2[in].value2\" placeholder=\"teléfono\" name=\"name{{in}}\" class=\"form-control formInput\" #name=\"ngModel\" required />\n              <select style=\"width: 50%;\" class=\"form-control formInput\" [(ngModel)]=\"grupoSang2\" name=\"Grupo Sanguineo\" id=\"\">\n                <option value=\"none\">Grupo Sanguineo</option>                                \n                <option value=\"1\">A +</option>\n                <option value=\"2\">A -</option>\n                <option value=\"3\">B +</option>\n                <option value=\"4\">B -</option>\n                <option value=\"5\">AB +</option>\n                <option value=\"6\">AB -</option>\n                <option value=\"7\">O +</option>\n                <option value=\"8\">O -</option>\n              </select>              \n              <input type=\"text\" style=\"width: 96%;\" [(ngModel)]=\"words2[in].value4\" placeholder=\"Profesión\" name=\"Profesion\" class=\"form-control formInput\" #name=\"ngModel\" required />              \n              <!--<p [hidden]=\"words2[in].value\">Field is required</p>\n              {{formRef.form.name1}}-->\n            </div>\n            <br />\n        </div>\n        <div style=\"display: flex; justify-content: center;\">\n            <button [disabled]=\"!formRef.form.valid\" (click)=\"add()\">Agregar Persona</button>\n        </div>\n    </form>\n\n    <label style=\"width: 80%; margin-left: 10%;\"> Localidad </label>\n    <select style=\"width: 80%; margin-left: 10%;\" class=\"form-control formInput\" [(ngModel)]=\"localidad\" name=\"Localidad\" id=\"\">        \n        <option value=\"1\">Usaquén</option>\n        <option value=\"2\">Chapinero</option>        \n        <option value=\"3\">Santa Fe</option>Santa Fe\n        <option value=\"4\">San Cristóbal</option>\n        <option value=\"5\">Usme</option>\n        <option value=\"6\">Tunjuelito</option>\n        <option value=\"7\">Bosa</option>\n        <option value=\"8\">Kennedy</option>\n        <option value=\"9\">Fontibón</option>\n        <option value=\"10\">Engativá</option>\n        <option value=\"11\">Suba</option>\n        <option value=\"12\">Barrios Unidos</option>\n        <option value=\"13\">Teusaquillo</option>\n        <option value=\"14\">Los Mártires</option>\n        <option value=\"15\">Antonio Nariño</option>\n        <option value=\"16\">Puente Aranda</option>\n        <option value=\"17\">Candelaria</option>\n        <option value=\"18\">Rafael Uribe Uribe</option>\n        <option value=\"19\">Ciudad Bolívar</option>\n        <option value=\"20\">Sumapaz</option>\n    </select>    \n</div>\n<div style=\"display: flex; justify-content: center; margin-top: 3%;\">\n    <button type=\"submit\" (click)=\"submit()\" class=\"btn btn-default\" [disabled]=\"!heroForm.valid\">Guardar Formulario</button> \n</div>\n\n<div *ngIf=\"submitted\">\n    <h2>You submitted the following:</h2>\n    <div *ngFor=\"let prop of formModelProps\">\n        <div class=\"row\">\n            <div class=\"col-md-2\">{{ prop | cameltotitle }}</div>\n            <div class=\"col-md-10 pull-left\">{{ heroForm.get(prop).value }}</div>\n        </div>\n    </div>    \n    <br />\n    <button class=\"btn btn-default\" (click)=\"submitted=false\">Edit</button>\n    <button class=\"btn btn-default\" (click)=\"submitAll()\">Enviar</button>\n</div>\n\n"
...
var ReactiveDynamicFormComponent = /** @class */ (function () {
    function ReactiveDynamicFormComponent() {
        this.formModelProps = [];
        this.words2 = [{ value: '', value2: '', value3: '', value4: '' }];
    }
    ReactiveDynamicFormComponent.prototype.ngOnInit = function () {
        this.model = new _shared_hero__WEBPACK_IMPORTED_MODULE_1__["Hero"](0, '', '', '');
        var formModel = {};
    ...
    ReactiveDynamicFormComponent.prototype.add = function () {
...
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm5/core.js");
/* harmony import */ var _angular_forms__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/forms */ "./node_modules/@angular/forms/fesm5/forms.js");
/* harmony import */ var _shared_hero__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../shared/hero */ "./src/app/shared/hero.ts");
var __decorate = (undefined && undefined.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var ReactiveFormComponent = /** @class */ (function () {
    ...
    ReactiveFormComponent.prototype.ngOnInit = function () {
        this.model = new _shared_hero__WEBPACK_IMPORTED_MODULE_2__["Hero"](18, 'Dr IQ', 'Really Smart', 'Chuck Overstreet');
        this.powers = ['Really Smart', 'Super Flexible',
            'Hypersound', 'Weather Changer'];
        this.heroForm = this.formBuilder.group({
            nombre: [this.model.nombre, _angular_forms__WEBPACK_IMPORTED_MODULE_1__["Validators"].required],
            altDireccionerEgo: [this.model.Direccion, _angular_forms__WEBPACK_IMPORTED_MODULE_1__["Validators"].required],
            barrio: [this.model.barrio, _angular_forms__WEBPACK_IMPORTED_MODULE_1__["Validators"].required]
        });
    };
...
var Hero = /** @class */ (function () {
    function Hero(id, nombre, Direccion, barrio, Telefono, estadoCivil, correoElectrónico, grupoSanguineo, profesion) {
        this.id = id;
        this.nombre = nombre;
...
var UpdateOnComponent = /** @class */ (function () {
    ...
    UpdateOnComponent.prototype.ngOnInit = function () {
        this.model = new _shared_hero__WEBPACK_IMPORTED_MODULE_1__["Hero"](18, 'Dr IQ', 'Really Smart', 'Chuck Overstreet');
        this.powers = ['Really Smart', 'Turbulent Breeze',
            'Super Hot', 'Weather Changer'];
        ...
        this.heroForm = new _angular_forms__WEBPACK_IMPORTED_MODULE_2__["FormGroup"]({
            ...
            name: new _angular_forms__WEBPACK_IMPORTED_MODULE_2__["FormControl"](this.model.nombre, _angular_forms__WEBPACK_IMPORTED_MODULE_2__["Validators"].required),
            alterEgo: new _angular_forms__WEBPACK_IMPORTED_MODULE_2__["FormControl"](this.model.Direccion, _angular_forms__WEBPACK_IMPORTED_MODULE_2__["Validators"].required),
            email: new _angular_forms__WEBPACK_IMPORTED_MODULE_2__["FormControl"](this.model.barrio, { validators: [_angular_forms__WEBPACK_IMPORTED_MODULE_2__["Validators"].required] }),
        }, { updateOn: 'blur' });
    };
...
module.exports = __webpack_require__(/*! /Users/andresfornaris/Desktop/Escritorio - Andres’s MacBook Pro/Angular-Forms/src/main.ts */"./src/main.ts");
